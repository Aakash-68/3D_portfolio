...
const CommitPP: React.FC<ProjectPageProps> = ({
  title,
  images,
  link = "#",
            ...
            <div className="flex flex-col gap-3">
              {["Highlights"].map((section) => (
                ...
                >
                  ...
                  >
                    Developed a Visual Studio Code extension that automates
                    time-based Git commits to streamline version control
                    workflows.
                  </p>
                </div>
              ))}
