...
const contactPlatforms = [
  {
    name: "GitHub",
    icon: Github,
    url: "https://github.com/Aakash-68",
    alt: "Visit my GitHub profile",
  },
  {
    name: "LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/aakash-yogabalu-0a85652a8",
    alt: "Connect with me on LinkedIn",
  },
  {
    name: "Email",
    icon: Mail,
    url: "aakash.27@unb.ca",
    alt: "Copy my email address",
  },
  {
    name: "Download Resume",
    icon: FileDown,
    url: "https://drive.google.com/uc?export=download&id=16jGZIDGlMPEPp9HGTrRkwF9Dm1gM26Kf",
    alt: "Download my resume (PDF)",
  },
];
            ...
            {contactPlatforms.map((platform) => {
              ...
              return (
                <a
                  ...
                  aria-label={platform.alt}
                  download={
                    platform.name === "Download Resume" ? true : undefined
                  }
                  className="group contact-icon relative flex items-center justify-center bg-gray-400/10 backdrop-blur-md rounded-full h-12 w-12 shadow-md transition-all duration-200 ease-in hover:bg-gray-300/15"
                >
                  <Icon
