...
const FloatingDockDesktop = ({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "mx-auto hidden h-16 items-end gap-4 rounded-2xl drop-shadow-2xl px-4 pb-3 md:flex bg-neutral-100",
        className,
      )}
    >
      {items.map((item) => (
  ...
  return (
    <a href={href}>
      <motion.div
        ...
        className="relative flex aspect-square items-center justify-center rounded-full bg-neutral-500"
      >
        <AnimatePresence>
          {hovered && (
            <motion.div
